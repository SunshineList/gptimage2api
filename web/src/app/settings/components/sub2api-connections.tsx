        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold tracking-tight text-foreground">Sub2API 连接管理</h2>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-secondary/30 px-6 py-10 text-center">
              <ServerCog className="size-8 text-muted-foreground/30" />
              <div className="space-y-1">
                <p className="text-sm font-medium text-muted-foreground">暂无 Sub2API 连接</p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="truncate text-xs text-muted-foreground">
                          {server.base_url}
                          {server.email ? ` · ${server.email}` : server.has_api_key ? " · API 密钥" : ""}
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        className="h-8 rounded-lg border-border bg-card px-3 text-xs text-muted-foreground"
                    ...
                    {importJob ? (
                      <div className="space-y-2 rounded-xl bg-secondary/30 px-3 py-3">
          ...
          <div className="rounded-xl bg-secondary/30 px-4 py-3 text-sm leading-6 text-muted-foreground">
            <p className="font-medium text-muted-foreground">使用说明</p>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={authMode} onValueChange={(value) => setAuthMode(value as AuthMode)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="api_key">管理员 API 密钥</SelectItem>
                </SelectContent>
              </Select>
            </div>
            {authMode === "password" ? (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={editingServer ? "留空则不修改密钥" : "Sub2API 管理员 API 密钥"}
                    className="h-11 rounded-xl border-border bg-card pr-10"
                  />
                  <button
                    type="button"
            ...
            <div className="space-y-2">
              ...
              {editingServer ? (
                <div className="flex items-center justify-between gap-2 text-xs text-muted-foreground">
                  ...
                  <Button
                    variant="outline"
                    className="h-8 rounded-lg border-border bg-card px-2 text-xs text-muted-foreground"
          ...
          <DialogFooter className="pt-2">
            <Button
              variant="secondary"
              className="h-10 rounded-xl bg-secondary px-5 text-foreground hover:bg-secondary"
        ...
        <DialogContent showCloseButton={false} className="max-h-[90vh] max-w-5xl rounded-2xl p-6">
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="outline"
                className="h-10 rounded-xl border-border bg-card px-4 text-foreground"
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {item.plan_type ? (
                            <Badge className="rounded-md bg-secondary text-muted-foreground">{item.plan_type}</Badge>
                          ) : null}
                          {item.status ? (
                            <Badge
